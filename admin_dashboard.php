    ...
    <div class="agileits-about py-md-5 py-5" id="services">
        <div class="container pt-lg-5">
            ...
            foreach ($cursor as $document) {
                ...
                if ($questions_added == 1) {
                    $questions_added = "Question Set: Ready";
                } else {
                    $questions_added = "Question Set: Not Ready";
                }

                if ($remedy_added == 1) {
                    $remedy_added = "Remedy Added: Yes";
                } else {
                    $remedy_added = "Remedy Added: No";
                }
                ?>
                <div class="col-lg-4 col-sm-6 agileits-about-grids">
                    <div class="p-md-5 p-sm-3">
                        ...
                        <h5><p><?php echo $questions_added; ?></p></h5>
                        <h5><p><?php echo $remedy_added; ?></p></h5>
                    </div>
                </div>
                <?php
            }
