...
<!-- header -->
    ...
    <div class="agileits-about py-md-5 py-5" id="services">
        <div class="container pt-lg-5">
            ...
            <div class="agileits-about-row row  text-left pt-md-0 pt-5">
			
			
				<div class="heading">Add Test question</div>
				<div class="form-col">
					<form action="test_result_back.php" method="post">
<?php
...
foreach ($cursor as $document) {
    ...
    ?>
    <br>
    <input type="text" class="form-control" placeholder="<?php echo $question; ?>" name="question" id="name" readonly>

    <div class="form-group">
        <select name="<?php echo $count; ?>" class="form-control">
