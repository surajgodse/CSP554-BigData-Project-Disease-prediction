    ...
    <div class="agileits-about py-md-5 py-5" id="services">
        <div class="container pt-lg-5">
            ...
            <div class="agileits-about-row row  text-center pt-md-0 pt-5">
				...
				<div class="heading">Add First-aid to Test</div>
				<div class="form-col">
					<form action="add_remedy_back.php" method="post">
						...
						<br>
						<textarea  type="text" class="form-control" placeholder="First Aid" name="description" class="form-control"></textarea>
						<br>
