            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-gradient-secondary pt-3">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-lg-auto text-center">
						...
						<li class="nav-item">
                            <a class="nav-link  text-white text-capitalize" href="message.php">View Messages</a>
                        </li>
						
						<li class="nav-item">
                            <a class="nav-link  text-white text-capitalize" href="feedback.php">View Feedback</a>
                        </li>
    ...
    <div class="agileits-about py-md-5 py-5" id="services">
        <div class="container pt-lg-5">
            <div class="title-section text-center pb-md-5">
                <h4>Poly clinic</h4>
                <h3 class="w3ls-title text-center text-capitalize">View Messages</h3>
            </div>
			...
			?>
                ...
                <div class="col-lg-4 col-sm-6 agileits-about-grids">
                    <div class="p-md-5 p-sm-3">
                        ...
                        <h4 class="mt-2 mb-3">Feedback By :<?php echo $name; ?></h4>
                        <h4 class="mt-2 mb-3"><?php echo $doctor; ?></h4>
						<h5 <p>Test taken : <?php echo $test; ?></p></h5>
