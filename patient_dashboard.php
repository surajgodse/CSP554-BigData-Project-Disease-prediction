...
foreach ($cursor as $document) {
    ...
    $questions_added = $document->questions_added;
    $remedy_added = $document->remedy_added;
    $test_description = $document->test_description;
    $test_id = $document->test_id;

    if ($questions_added == 0 || $remedy_added == 0) {
        continue;
    }
    ?>
    <div class="col-lg-4 col-sm-6 agileits-about-grids">
        <div class="p-md-5 p-sm-3">
            ...
            <h4 class="mt-2 mb-3"><?php echo $test_name; ?></h4>
            <p><?php echo $test_description; ?></p>
            <a class="mt-2 mb-3" href="start_test.php?test_id=<?php echo $test_id; ?>">Take Test</a>
        </div>
    </div>
<?php
}
