...
<head>
    ...
    <meta charset="utf-8" />
    <meta name="keywords" content="WellnessNavigator Clinic, Bootstrap Web Templates, Flat Web Templates, Android Compatible web template, 
    ...
    <div class="agileits-about py-md-5 py-5" id="services">
        <div class="container pt-lg-5">
            ...
            <div class="agileits-about-row row  text-center pt-md-0 pt-5">
				...
				<div class="heading">Add Docotr as per Disease</div>
				<div class="form-col">
					<form action="add_docotr_back.php" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <select name="test_id" class="form-control">
                                ...
                                $cursor = $manager->executeQuery("$databaseName.test_category", $query);
						...
						<br>
						<input type="text" class="form-control" placeholder="Eduaction" name="education" id="name" required="">
						<br>
						<input type="text" class="form-control" placeholder="Speciality" name="speciality" id="name" required="">
						<br>
						<input type="text" class="form-control" placeholder="address" name="address" id="name" required="">
						<br>
						<input type="number" class="form-control" placeholder="Contact Details" name="contact" id="name" required="">
						<br>
